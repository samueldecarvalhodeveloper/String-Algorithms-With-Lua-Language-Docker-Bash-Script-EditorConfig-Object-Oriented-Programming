...
function MostSignificantDigitSortRadixExecutor.get_sorted_list(
  list_to_be_sorted,
  list_starting_index,
  list_ending_index,
  ...
  for current_list_index = list_starting_index, list_ending_index do
    ...
    sorted_list[list_of_initial_indexes[current_character_position_index]] = list_to_be_sorted[current_list_index]
...
return MostSignificantDigitSortRadixExecutor
